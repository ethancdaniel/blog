...
func init() {
	proto.RegisterType((*MsgCreateComment)(nil), "ethancdaniel.blog.blog.MsgCreateComment")
	proto.RegisterType((*MsgCreateCommentResponse)(nil), "ethancdaniel.blog.blog.MsgCreateCommentResponse")
	proto.RegisterType((*MsgUpdateComment)(nil), "ethancdaniel.blog.blog.MsgUpdateComment")
	proto.RegisterType((*MsgUpdateCommentResponse)(nil), "ethancdaniel.blog.blog.MsgUpdateCommentResponse")
	proto.RegisterType((*MsgDeleteComment)(nil), "ethancdaniel.blog.blog.MsgDeleteComment")
	proto.RegisterType((*MsgDeleteCommentResponse)(nil), "ethancdaniel.blog.blog.MsgDeleteCommentResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	,
}
...
func (c *msgClient) CreateComment(ctx context.Context, in *MsgCreateComment, opts ...grpc.CallOption) (*MsgCreateCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ethancdaniel.blog.blog.Msg/CreateComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateComment(ctx context.Context, in *MsgUpdateComment, opts ...grpc.CallOption) (*MsgUpdateCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ethancdaniel.blog.blog.Msg/UpdateComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteComment(ctx context.Context, in *MsgDeleteComment, opts ...grpc.CallOption) (*MsgDeleteCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ethancdaniel.blog.blog.Msg/DeleteComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethancdaniel.blog.blog.Msg/CreateComment",
	}
...
func _Msg_UpdateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethancdaniel.blog.blog.Msg/UpdateComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ethancdaniel.blog.blog.Msg/DeleteComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ethancdaniel.blog.blog.Msg",
