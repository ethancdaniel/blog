...
func init() {
	proto.RegisterType((*Post)(nil), "ethancdaniel.blog.blog.Post")
	proto.RegisterType((*MsgCreatePost)(nil), "ethancdaniel.blog.blog.MsgCreatePost")
}
...
var fileDescriptor_1da4a141e1c534d3 = []byte{
	...
	0xd7, 0x2f, 0xc8, 0x2f, 0x2e, 0xd1, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x4b, 0x2d, 0xc9,
	0x48, 0xcc, 0x4b, 0x4e, 0x49, 0xcc, 0xcb, 0x4c, 0xcd, 0xd1, 0x03, 0xc9, 0x82, 0x09, 0x29, 0x91,
	0xf4, 0xfc, 0xf4, 0x7c, 0xb0, 0x12, 0x7d, 0x10, 0x0b, 0xa2, 0x5a, 0xa9, 0x8c, 0x8b, 0x25, 0x20,
	...
	0x20, 0x1c, 0x21, 0x21, 0x2e, 0x96, 0xa4, 0xfc, 0x94, 0x4a, 0x09, 0x16, 0xb0, 0x20, 0x98, 0x2d,
	0x24, 0xc5, 0xc5, 0x91, 0x9c, 0x9f, 0x9b, 0x9b, 0x9a, 0x57, 0x52, 0x2c, 0xc1, 0x0a, 0x16, 0x87,
	0xf3, 0x95, 0x82, 0xb9, 0x78, 0x7d, 0x8b, 0xd3, 0x9d, 0x41, 0x76, 0xa4, 0x12, 0x70, 0x00, 0xdc,
	0x42, 0x26, 0x6c, 0x16, 0x32, 0x23, 0x2c, 0x74, 0x72, 0x3e, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23,
	...
	0xe4, 0xf0, 0xd1, 0x07, 0x87, 0x5e, 0x05, 0x84, 0x2a, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03,
	0x07, 0x8c, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x17, 0xa6, 0x1f, 0xef, 0x59, 0x01, 0x00, 0x00,
}
...
func (m *Post) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Comments) > 0 {
		...
		i = encodeVarintPost(dAtA, i, uint64(len(m.Comments)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Body) > 0 {
