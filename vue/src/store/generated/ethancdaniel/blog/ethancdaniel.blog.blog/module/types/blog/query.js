...
export class QueryClientImpl {
    ...
    Comment(request) {
        ...
        const promise = this.rpc.request("ethancdaniel.blog.blog.Query", "Comment", data);
    ...
    CommentAll(request) {
        ...
        const promise = this.rpc.request("ethancdaniel.blog.blog.Query", "CommentAll", data);
    ...
    Post(request) {
        ...
        const promise = this.rpc.request("ethancdaniel.blog.blog.Query", "Post", data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request("ethancdaniel.blog.blog.Query", "PostAll", data);
